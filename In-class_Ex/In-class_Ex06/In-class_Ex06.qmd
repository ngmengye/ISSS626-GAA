...
Spatio-temporal refers anything that involves both space and time.
...
2. assesses whether the values in a time series follow a consistent upward or downward trend over time.
3. 
...
Analyze how GDP per capita changes over both space and time
Spacetime cube combines both dimensions to enable a deeper understanding of the dynamics of my data.
