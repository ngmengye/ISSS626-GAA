...
Notes:\
Relatively small size data. Nothing to do with complexity

You will attribute data, thin and long data, across different year, create table

you got small islands, the centroid will go into the water

from 2019-2023

3 temporal temp: pre-covid, covid and post covid, dissect it

spatial distribution: bangkok has the highest, the rest are quite same

key indicators (more than 1 indicator, which are the measures , not just revenue)

Hands-on exercise on Hunan got hints for indicators

cross-sectional: pre, covid and post, space and time,

G\* to detect hot and cold spot (days, month or week continuous)

what is the constraint of the data to not allow you to make it continuous

spacetime cube, space dimension data, focus on sfdep!!! refer to the articles
